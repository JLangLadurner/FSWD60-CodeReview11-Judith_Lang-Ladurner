...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/style01.css">
   <title>Travelblog  |  Add Concerts</title>
...
<fieldset>
   <legend>Add Concerts</legend>

   <form action="actions/a_create_con.php" method="post">
       <table cellspacing="1" cellpadding="1">

           <tr>
               <th>Concert Name</th>
               <td><input type="text" name="con_name" placeholder="Enter Name" /></td>
           </tr>     
           <tr>
               <th>Date</th>
               <td><input type="text" name="con_date" placeholder="JJJJ-MM-DD" /></td>
           </tr>
           <tr>
               <th>Time</th>
               <td><input type="text" name="con_start" placeholder="HH:MM:SS" /></td>
           </tr>
           <tr>
               <th>Price</th>
               <td><input type="text" name="con_price" placeholder="Price" /></td>
           </tr>
           <tr>
               <th>con_address</th>
               <td><input type="text" name="con_address" placeholder="address" /></td>
           </tr>
           ...
           <tr>
               <th>Web Address</th>
               <td><input type="text" name="con_web" placeholder="please insert web address" /></td>
           </tr>
           
           <tr>
               <th>Image</th>
               <td><input type="text" name="con_img" placeholder="please insert picture URL" /></td>
           </tr>
           <tr>
               <th>Type</th>
               <td><select type="text" name="con_type" placeholder="Please choose" />
            ...
            <tr>
               <td><button class="btn btn-success move" type="submit">Insert Concert</button></td>
